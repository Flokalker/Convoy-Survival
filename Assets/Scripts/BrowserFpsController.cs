...
public class BrowserFpsController : MonoBehaviour
{
    ...
    [SerializeField] private bool lockCursorOnMovementInput = true;

    [Header("Respawn")]
    [SerializeField] private float respawnYThreshold = -6f;
    ...
    private void HandleCursorInput()
    {
        ...
        if (lockCursorOnMovementInput && keyboard != null && HasMovementInput(keyboard))
        {
            SetCursorLocked(true);
        }
    }
    ...
    private static bool HasMovementInput(Keyboard keyboard)
    {
